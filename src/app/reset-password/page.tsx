...
import { ShieldCheck, Lock, Eye, EyeOff, Loader2, AlertCircle, KeyRound } from 'lucide-react'
  ...
  if (!token) {
    return (
      <div className="text-center">
        ...
        <h1 className="mt-6 text-2xl font-bold tracking-tight text-white">Invalid reset link</h1>
        ...
        <div className="mt-8">
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 px-6 py-3 text-sm font-semibold text-zinc-950 shadow-md transition duration-200 hover:from-emerald-400 hover:to-teal-500"
          >
